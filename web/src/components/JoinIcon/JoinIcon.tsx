...
export const JoinIcon = forwardRef<SVGSVGElement, SVGProps<SVGSVGElement>>(
  (props, ref) => {
    return (
      <svg ref={ref} viewBox="0 0 672.5315 738.39398" {...props}>
        {/* Ship Cockpit */}
        <path
          className="fill-cyan"
        ...
        <circle
          ...
          r="4.78622"
        />
        <circle className="fill-white" cx="542" cy="697.39398" r="6" />
