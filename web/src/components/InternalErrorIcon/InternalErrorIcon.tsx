...
export function InternalErrorIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 1119.60911 699" {...props}>
      ...
      {/* Being */}
      <circle className="fill-muted" cx="316.60911" cy="538" r="79" />
      <rect
        className="fill-muted"
        height="43"
        width="24"
      ...
      <ellipse
        ...
        ry="7.5"
      />
      <circle className="fill-white" cx="318.60911" cy="518" r="27" />
      <circle className="fill-muted" cx="318.60911" cy="518" r="9" />
      <path
        className="fill-cyan"
