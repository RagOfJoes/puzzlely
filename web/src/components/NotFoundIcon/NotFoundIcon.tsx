...
const NotFoundIcon = (props: IconProps) => {
  ...
  const leaf = '#ccc';
  const floor = '#ccc';
  const backgroundShapes = '#ccc';
  const questionMark = colors.primary;
  // Beings
  const beingTwoHat = '#ccc';
  const beingColor = colors.slate;
  const beingOneHat = colors.primary;

  return (
    <Icon viewBox="0 0 523 336" {...props}>
      <circle
        r="43.06732"
        cx="766.34968"
        cy="561.77555"
      ...
      />
      <circle cx="223.88636" cy="273.94632" r="43.06734" fill={beingColor} />
      <rect
        y="307.746"
        x="230.42822"
        width="13.08374"
